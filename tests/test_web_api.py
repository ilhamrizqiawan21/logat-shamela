...
class ApiTests(unittest.TestCase):
    def test_api_contract_contains_reader_endpoints(self):
        ...
        self.assertTrue({"/api/books", "/api/books/{book_id}", "/api/page", "/api/index", "/api/search", "/api/annotation", "/api/bookmark", "/api/bookmarks", "/api/suggestions", "/api/data/export", "/api/data/import"} <= paths)
